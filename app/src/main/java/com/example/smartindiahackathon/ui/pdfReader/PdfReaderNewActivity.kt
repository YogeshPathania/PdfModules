...
import com.example.smartindiahackathon.databinding.NewPdfLayoutBinding
import com.itextpdf.text.pdf.PdfReader
import com.itextpdf.text.pdf.parser.PdfTextExtractor

const val TAG = "MainActivity"

class PdfReaderNewActivity : AppCompatActivity(), TextToSpeech.OnInitListener {

    lateinit var binding: NewPdfLayoutBinding
    lateinit var tts: TextToSpeech
    lateinit var reader: PdfReader

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = NewPdfLayoutBinding.inflate(layoutInflater)
        ...
        tts.setOnUtteranceProgressListener(
            object : UtteranceProgressListener() {
                ...
                override fun onError(p0: String?) {
                    Toast.makeText(
                        this@PdfReaderNewActivity, "Error : $p0", Toast.LENGTH_LONG
                    ).show()
                }
            }
        )
